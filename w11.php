...
<body class="bg-amber-50 min-h-screen flex flex-col">
    ...
    <nav class="bg-[#EEC900] text-amber-900 p-4 flex justify-between items-center px-10 shadow-lg">
        ...
        <a href="index.php" class="hover:text-pink-500 transition self-center">คำอธิบาย</a>

        <div class="relative group py-2">
            <button class="hover:text-pink-500 transition flex items-center gap-1 focus:outline-none">
                การเขียนโปรแกรมแบบมีเงื่อนไข ▾
            </button>
            <div class="absolute hidden group-hover:block bg-white shadow-xl rounded-lg border border-blue-50 mt-0 w-56 py-2 z-50">
                <a href="w01.php" class="block px-4 py-2 hover:bg-[#e0eee0]-50 hover:text-pink-600 transition">1.1 คำนวณเงินเดือน</a>
                <a href="w02.php" class="block px-4 py-2 hover:bg-[#e0eee0]-50 hover:text-pink-600 transition">1.2 ภาษีรถยนต์</a>
                <a href="w03.php" class="block px-4 py-2 hover:bg-[#e0eee0]-50 hover:text-pink-600 transition">1.3 ค่าไฟฟ้า</a>
                <a href="w04.php" class="block px-4 py-2 hover:bg-[#e0eee0]-50 hover:text-pink-600 transition">1.4 ค่าแรงพนักงาน</a>
                <a href="w05.php" class="block px-4 py-2 hover:bg-[#e0eee0]-50 hover:text-pink-600 transition">1.5 ค่าเน็ต</a>
                <a href="w06.php" class="block px-4 py-2 hover:bg-[#e0eee0]-50 hover:text-pink-600 transition">1.6 เช็คเลขคู่หรือคี่</a>
            </div>
        </div>
        ...
        <div class="relative group py-2">
            ...
            <div class="absolute hidden group-hover:block bg-white shadow-xl rounded-lg border border-blue-50 mt-0 w-56 py-2 z-50">
                <a href="w07.php" class="block px-4 py-2 hover:bg-blue-50 hover:text-blue-600 transition">2.1 คำนวณผลรวมเลขคู่</a>
                <a href="w08.php" class="block px-4 py-2 hover:bg-blue-50 hover:text-blue-600 transition">2.2 คำนวณผลคูณของตัวเลข</a>
                <a href="w09.php" class="block px-4 py-2 hover:bg-blue-50 hover:text-blue-600 transition">2.3 ตาราฃสูตรคูณ</a>
                <a href="w10.php" class="block px-4 py-2 hover:bg-blue-50 hover:text-blue-600 transition">2.4 สร้างรูปแบบตัวเลขสามเหลี่ยม</a>
                <a href="w11.php" class="block px-4 py-2 hover:bg-blue-50 hover:text-blue-600 transition">2.5 สร้างรูปพีระมิดดาว</a>
                <a href="w12.php" class="block px-4 py-2 hover:bg-blue-50 hover:text-blue-600 transition">2.6 คำนวณเลขยกกำลัง</a>
                <a href="w13.php" class="block px-4 py-2 hover:bg-blue-50 hover:text-blue-600 transition">2.7 ค้นหสจำนวนเฉพาะ</a>
            </div>
        </div>
    </nav>
